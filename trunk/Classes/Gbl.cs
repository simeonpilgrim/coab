...
namespace Classes
{
    ...
    public class gbl
    {
        ...
        public static SpellEntry[] spell_table = { /* seg600:37DC asc_19AEC */
            ...
            new SpellEntry(2, 1, 0, 2, 0, 10, 4, 2, 1, 4, Affects.affect_0d, 2, 1, 0, 1, 0), 
            ...
            new SpellEntry(2, 2, 3, 0, 0, 1, 9, 0, 3, 0, Affects.affect_1e, 1, 2, 5, 1, 1), 
            ...
            new SpellEntry(0, 4, 3, 0, 0, 2, 4, 0, 0, 4, Affects.affect_03, 1, 7, 4, 1, 0), 
            ...
            new SpellEntry(1, 1, 8, 0, 10, 0, 11, 0, 1, 4, Affects.affect_88, 1, 3, 3, 1, 0), 
            ...
            new SpellEntry(3, 5, 1, 0, 0, 0, 0xF0, 4, 0, 4, Affects.funky__32, 2, 5, 0, 0, 0), 
            new SpellEntry(2, 5, 2, 0, 0, 1, 9, 0, 0, 4, 0, 2, 5, 5, 1, 0), 
            new SpellEntry(2, 5, 6, 0, 0, 0, 8, 0, 2, 4, 0, 1, 5, 6, 1, 0), 
            new SpellEntry(2, 5, 16, 0, 0, 0, 4, 0, 1, 4, Affects.feeble, 1, 5, 6, 1, 0), 
