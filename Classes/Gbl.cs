...
namespace Classes
{
	...
	public class gbl
	{
		...
		public static SpellEntry[] spellCastingTable = { /* seg600:37DC asc_19AEC */
			null, 
			new SpellEntry(1, SpellClass.Cleric,    1, 6, 0, 6, 0, 10, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.bless, SpellWhen.Both, 10, 1, 0, 0), 
			new SpellEntry(2, SpellClass.Cleric,    1, 6, 0, 6, 0, 10, SpellTargets.Combat, DamageOnSave.Normal,  SaveVerseType.type4, Affects.cursed, SpellWhen.Combat, 10, 3, 1, 0), 
			new SpellEntry(3, SpellClass.Cleric,    1, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal,   SaveVerseType.type4, Affects.none, SpellWhen.Both, 5, 1, 0, 0), 
			new SpellEntry(4, SpellClass.Cleric,    1, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal,  SaveVerseType.type4, Affects.none, SpellWhen.Combat, 5, 2, 1, 0), 
			new SpellEntry(5, SpellClass.Cleric,    1, 3, 0, 10, 0, 0, SpellTargets.Self, DamageOnSave.Normal,  SaveVerseType.type4, Affects.detect_magic, SpellWhen.Both, 1, 0, 0, 0), 
			new SpellEntry(6, SpellClass.Cleric,    1, 0, 0, 0, 3, 4, SpellTargets.PartyMember, DamageOnSave.Normal,   SaveVerseType.type4, Affects.protection_from_evil, SpellWhen.Both, 4, 1, 0, 0), 
			new SpellEntry(7, SpellClass.Cleric,    1, 0, 0, 0, 3, 4, SpellTargets.PartyMember, DamageOnSave.Normal,   SaveVerseType.type4, Affects.protection_from_good, SpellWhen.Both, 4, 1, 0, 0), 
			new SpellEntry(8, SpellClass.Cleric,    1, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal,  SaveVerseType.type4, Affects.resist_cold, SpellWhen.Both, 10, 0, 0, 0), 
			new SpellEntry(9, SpellClass.MagicUser, 1, 0, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 1, 2, 1, 0), 
			new SpellEntry(0xa, SpellClass.MagicUser, 1, 12, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.charm_person, SpellWhen.Combat, 1, 4, 1, 0), 
			new SpellEntry(0xb, SpellClass.MagicUser, 1, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.detect_magic, SpellWhen.Both, 1, 0, 0, 0), 
			new SpellEntry(0xc, SpellClass.MagicUser, 1, 0, 2, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.enlarge, SpellWhen.Both, 1, 0, 0, 0), 
			new SpellEntry(0xd, SpellClass.MagicUser, 1, 0, 2, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Zero, SaveVerseType.type4, Affects.reduce, SpellWhen.Both, 1, 0, 1, 0), 
			new SpellEntry(0xe, SpellClass.MagicUser, 1, 0, 0, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.friends, SpellWhen.Camp, 1, 0, 0, 0), 
			new SpellEntry(0xf, SpellClass.MagicUser, 1, 6, 4, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 1, 4, 1, 0), 
			new SpellEntry(0x10, SpellClass.MagicUser, 1, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.protection_from_evil, SpellWhen.Both, 1, 1, 0, 0), 
			new SpellEntry(0x11, SpellClass.MagicUser, 1, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.protection_from_good, SpellWhen.Both, 1, 1, 0, 0), 
			new SpellEntry(0x12, SpellClass.MagicUser, 1, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.read_magic, SpellWhen.Camp, 10, 0, 0, 0), 
			new SpellEntry(0x13, SpellClass.MagicUser, 1, 0, 0, 0, 5, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.shield, SpellWhen.Both, 1, 2, 0, 0), 
			new SpellEntry(0x14, SpellClass.MagicUser, 1, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 1, 2, 1, 0), 
			new SpellEntry(0x15, SpellClass.MagicUser, 1, 3, 4, 0, 5, 9, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.sleep, SpellWhen.Combat, 1, 2, 1, 1), 
			new SpellEntry(0x16, SpellClass.Cleric,    2, 0, 0, 30, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.find_traps, SpellWhen.Camp, 5, 0, 0, 0), 
			new SpellEntry(0x17, SpellClass.Cleric,    2, 6, 0, 4, 1, 6, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.paralyze, SpellWhen.Combat, 5, 6, 1, 0), 
			new SpellEntry(0x18, SpellClass.Cleric,    2, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.resist_fire, SpellWhen.Both, 5, 1, 0, 0), 
			new SpellEntry(0x19, SpellClass.Cleric,    2, 12, 0, 0, 2, 31, SpellTargets.Combat, DamageOnSave.Unknown_3, SaveVerseType.type4, Affects.silence_15_radius, SpellWhen.Combat, 5, 4, 1, 1), /* 396C - */            
			new SpellEntry(0x1a, SpellClass.Cleric,    2, 0, 0, 0, 60, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.slow_poison, SpellWhen.Both, 1, 0, 0, 0), 
			new SpellEntry(0x1b, SpellClass.Cleric,    2, 3, 0, 0, 0, 240, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.snake_charm, SpellWhen.Combat, 5, 0, 1, 0), 
			new SpellEntry(0x1c, SpellClass.Cleric,    2, 3, 0, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.spiritual_hammer, SpellWhen.Both, 5, 1, 0, 0), 
			new SpellEntry(0x1d, SpellClass.MagicUser, 2, 0, 4, 0, 5, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.detect_invisibility, SpellWhen.Both, 2, 1, 0, 0), 
			new SpellEntry(0x1e, SpellClass.MagicUser, 2, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.invisibility, SpellWhen.Both, 2, 2, 0, 0), 
			new SpellEntry(0x1f, SpellClass.MagicUser, 2, 0, 0, 0, 0, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Camp, 1, 0, 0, 0), 
			new SpellEntry(0x20, SpellClass.MagicUser, 2, 0, 0, 0, 2, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.mirror_image, SpellWhen.Both, 2, 3, 0, 0), 
			new SpellEntry(0x21, SpellClass.MagicUser, 2, 1, 1, 0, 1, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.ray_of_enfeeblement, SpellWhen.Combat, 2, 2, 1, 0), 
			...
			new SpellEntry(0x23, SpellClass.MagicUser, 2, 0, 0, 0, 60, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.strength, SpellWhen.Camp, 10, 0, 0, 0), 
			new SpellEntry(0x24, SpellClass.Monster,   7, 4, 0, 0, 0, 8, SpellTargets.WholeParty, DamageOnSave.Zero, SaveVerseType.type4, Affects.none, SpellWhen.Both, 0, 2, 0, 0), 
			new SpellEntry(0x25, SpellClass.Cleric,    3, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 10, 0, 0, 0), 
			new SpellEntry(0x26, SpellClass.Cleric,    3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.blinded, SpellWhen.Combat, 10, 3, 1, 0), 
			new SpellEntry(0x27, SpellClass.Cleric,    3, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Camp, 100, 0, 0, 0), 
			new SpellEntry(0x28, SpellClass.Cleric,    3, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.cause_disease_1, SpellWhen.Combat, 100, 4, 1, 0), 
			new SpellEntry(0x29, SpellClass.Cleric,    3, 6, 0, 0, 0, 9, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 4, 3, 1, 1), 
			new SpellEntry(0x2a, SpellClass.Cleric,    3, 0, 0, 0, 1, 0, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.prayer, SpellWhen.Both, 6, 5, 0, 0), 
			new SpellEntry(0x2b, SpellClass.Cleric,    3, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 6, 0, 0, 0), 
			new SpellEntry(0x2c, SpellClass.Cleric,    3, -1, 0, 0, 10, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.bestow_curse, SpellWhen.Combat, 6, 5, 1, 0), 
			new SpellEntry(0x2d, SpellClass.MagicUser, 3, 0, 0, 0, 1, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.blink, SpellWhen.Combat, 1, 2, 0, 0), 
			new SpellEntry(0x2e, SpellClass.MagicUser, 3, 12, 0, 0, 1, 9, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 3, 2, 1, 1), 
			new SpellEntry(0x2f, SpellClass.MagicUser, 3, 10, 1, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none,SpellWhen.Combat, 3, 7, 1, 3), 
			new SpellEntry(0x30, SpellClass.MagicUser, 3, 6, 0, 3, 1, 10, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.haste, SpellWhen.Both, 3, 3, 0, 0), 
			new SpellEntry(0x31, SpellClass.MagicUser, 3, 12, 0, 0, 2, 7, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.paralyze, SpellWhen.Combat, 3, 6, 1, 0), 
			new SpellEntry(0x32, SpellClass.MagicUser, 3, 0, 0, 0, 0, 9, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.invisibility, SpellWhen.Both, 3, 1, 0, 0), 
			new SpellEntry(0x33, SpellClass.MagicUser, 3, 4, 1, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 3, 6, 1, 0), 
			new SpellEntry(0x34, SpellClass.MagicUser, 3, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.prot_from_evil_10_radius, SpellWhen.Both, 3, 1, 0, 0), 
			new SpellEntry(0x35, SpellClass.MagicUser, 3, 0, 0, 0, 2, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.prot_from_good_10_radius, SpellWhen.Both, 3, 2, 0, 0), 
			new SpellEntry(0x36, SpellClass.MagicUser, 3, 0, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.prot_from_normal_missiles, SpellWhen.Both, 3, 3, 0, 0), 
			new SpellEntry(0x37, SpellClass.MagicUser, 3, 9, 1, 3, 1, 10, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.slow, SpellWhen.Combat, 3, 4, 1, 0), 
			new SpellEntry(0x38, SpellClass.Cleric,    7, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 6, 0, 0, 0), 
			new SpellEntry(0x39, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.haste, SpellWhen.Both, 0, 3, 0, 0), 
			new SpellEntry(0x3a, SpellClass.Cleric,    4, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 7, 1, 0, 0), 
			new SpellEntry(0x3b, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.strength, SpellWhen.Both, 0, 1, 0, 0), 
			new SpellEntry(0x3c, SpellClass.Monster,   6, 4, 4, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 0, 7, 1, 0), 
			...
			new SpellEntry(0x3e, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.haste, SpellWhen.Both, 0, 1, 0, 0), 
			new SpellEntry(0x3f, SpellClass.Monster,   6, 0, 0, 0, 0, 7, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.invisible, SpellWhen.Both, 0, 2, 0, 0), 
			new SpellEntry(0x40, SpellClass.Monster,   6, 7, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 0, 7, 1, 3), 
			new SpellEntry(0x41, SpellClass.Monster,   6, 12, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 0, 6, 1, 0), 
			new SpellEntry(0x42, SpellClass.Cleric,    4, 0, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 7, 5, 1, 0), 
			new SpellEntry(0x43, SpellClass.Cleric,    4, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Camp, 7, 0, 0, 0), 
			...
			new SpellEntry(0x45, SpellClass.Cleric,    4, 3, 0, 0, 10, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.prot_from_evil_10_radius, SpellWhen.Both, 7, 2, 0, 0), 
			new SpellEntry(0x46, SpellClass.Cleric,    4, 3, 0, 0, 2, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.sticks_to_snakes, SpellWhen.Combat, 7, 4, 1, 0), 
			new SpellEntry(0x47, SpellClass.Cleric,    5, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 8, 2, 0, 0), 
			new SpellEntry(0x48, SpellClass.Cleric,    5, -1, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 8, 6, 1, 0), 
			new SpellEntry(0x49, SpellClass.Cleric,    5, 0, 0, 0, 1, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.sp_dispel_evil, SpellWhen.Combat, 8, 3, 0, 0), 
			new SpellEntry(0x4a, SpellClass.Cleric,    5, 6, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 8, 6, 1, 0), 
			new SpellEntry(0x4b, SpellClass.Cleric,    5, 0, 0, 0, 0, 0, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Camp, 10, 1, 0, 0), 
			new SpellEntry(0x4c, SpellClass.Cleric,    5, 3, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 10, 7, 1, 0), 
			new SpellEntry(0x4d, SpellClass.Druid,     1, 3, 0, 12, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.detect_magic, SpellWhen.Both, 3, 1, 0, 0), 
			new SpellEntry(0x4e, SpellClass.Druid,     1, 8, 0, 10, 0, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.entangle, SpellWhen.Combat, 3, 3, 1, 0), 
			new SpellEntry(0x4f, SpellClass.Druid,     1, 8, 0, 0, 4, 5, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.faerie_fire, SpellWhen.Combat, 3, 4, 1, 0), 
			new SpellEntry(0x50, SpellClass.Druid,     1, -1, 0, 10, 1, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.invisible_to_animals, SpellWhen.Both, 4, 1, 1, 0), 
			new SpellEntry(0x51, SpellClass.MagicUser, 4, 6, 0, 0, 0, 5, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.charm_person, SpellWhen.Combat, 4, 6, 1, 0), 
			new SpellEntry(0x52, SpellClass.MagicUser, 4, 12, 0, 2, 1, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.confuse, SpellWhen.Combat, 4, 7, 1, 0), 
			new SpellEntry(0x53, SpellClass.MagicUser, 4, 0, 3, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 1, 0, 1, 0), 
			new SpellEntry(0x54, SpellClass.MagicUser, 4, 6, 0, 0, 1, 8, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.fear, SpellWhen.Combat, 4, 6, 1, 0), 
			new SpellEntry(0x55, SpellClass.MagicUser, 4, 0, 0, 2, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 4, 8, 0, 0), 
			new SpellEntry(0x56, SpellClass.MagicUser, 4, 0, 1, 0, 1, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.fumbling, SpellWhen.Combat, 4, 4, 1, 0), 
			new SpellEntry(0x57, SpellClass.MagicUser, 4, 0, 1, 0, 0, 10, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 4, 7, 1, 0), 
			new SpellEntry(0x58, SpellClass.MagicUser, 4, 0, 1, 0, 1, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.minor_globe_of_invulnerability, SpellWhen.Both, 4, 5, 0, 0), 
			new SpellEntry(0x59, SpellClass.MagicUser, 4, 0, 0, 0, 0, 4, SpellTargets.PartyMember, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 4, 0, 0, 0), 
			new SpellEntry(0x5a, SpellClass.Monster,   5, 1, 0, 0, 0, 240, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.type4, Affects.animate_dead, SpellWhen.Both, 5, 0, 0, 0), 
			new SpellEntry(0x5b, SpellClass.MagicUser, 5, 2, 0, 0, 1, 9, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 5, 5, 1, 0), 
			new SpellEntry(0x5c, SpellClass.MagicUser, 5, 6, 0, 0, 0, 8, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 5, 6, 1, 0), 
			new SpellEntry(0x5d, SpellClass.MagicUser, 5, 16, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.feeblemind, SpellWhen.Combat, 5, 6, 1, 0), 
			new SpellEntry(0x5e, SpellClass.MagicUser, 5, 0, 1, 0, 1, 7, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.paralyze, SpellWhen.Combat, 5, 7, 1, 0), 
			new SpellEntry(0x5f, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.prot_drag_breath, SpellWhen.Both, 10, 1, 0, 0), 
			new SpellEntry(0x60, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.resist_paralyze, SpellWhen.Both, 10, 1, 0, 0), 
			new SpellEntry(0x61, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.invisibility, SpellWhen.Both, 0, 1, 0, 0), 
			new SpellEntry(0x62, SpellClass.Monster,   6, 3, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 0, 1, 1, 0), 
			new SpellEntry(0x63, SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.type4, Affects.none, SpellWhen.Both, 0, 1, 0, 0), 
			new SpellEntry(0x64, SpellClass.MagicUser, 4, 0, 0, 0, 10, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.type4, Affects.none, SpellWhen.Combat, 4, 4, 1, 0), 
