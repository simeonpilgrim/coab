...
namespace Classes
{
    ...
    public class gbl
    {
        ...
        public static SpellEntry[] spellCastingTable = { /* seg600:37DC asc_19AEC */
            ...
            new SpellEntry(Spells.spell_39,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.haste, SpellWhen.Both, 0, 3, 0, 0),
            ...
            new SpellEntry(Spells.spell_3b,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.strength, SpellWhen.Both, 0, 1, 0, 0),
            ...
            new SpellEntry(Spells.spell_3d,                     SpellClass.Monster,   6, 6, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Poison, Affects.paralyze, SpellWhen.Combat, 0, 7, 1, 0),
            ...
            new SpellEntry(Spells.spell_3f,                     SpellClass.Monster,   6, 0, 0, 0, 0, 7, SpellTargets.WholeParty, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisible, SpellWhen.Both, 0, 2, 0, 0),
            new SpellEntry(Spells.spell_40,                     SpellClass.Monster,   6, 7, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Half, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 7, 1, 3),
            new SpellEntry(Spells.spell_41,                     SpellClass.Monster,   6, 12, 0, 0, 0, 4, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 6, 1, 0),
            ...
            new SpellEntry(Spells.dispel_evil,                  SpellClass.Cleric,    5, 0, 0, 0, 1, 0, SpellTargets.Combat, DamageOnSave.Normal, SaveVerseType.Spell, Affects.sp_dispel_evil, SpellWhen.Combat, 8, 3, 0, 0),
            ...
            new SpellEntry(Spells.spell_5f,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.prot_drag_breath, SpellWhen.Both, 10, 1, 0, 0),
            new SpellEntry(Spells.spell_60,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.resist_paralyze, SpellWhen.Both, 10, 1, 0, 0),
            new SpellEntry(Spells.spell_61,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.invisibility, SpellWhen.Both, 0, 1, 0, 0),
            new SpellEntry(Spells.spell_62,                     SpellClass.Monster,   6, 3, 0, 0, 0, 11, SpellTargets.Combat, DamageOnSave.Zero, SaveVerseType.Spell, Affects.none, SpellWhen.Combat, 0, 1, 1, 0),
            new SpellEntry(Spells.spell_63,                     SpellClass.Monster,   6, 0, 0, 0, 0, 0, SpellTargets.Self, DamageOnSave.Normal, SaveVerseType.Spell, Affects.none, SpellWhen.Both, 0, 1, 0, 0),
