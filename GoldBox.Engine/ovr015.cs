...
namespace GoldBox.Engine
{
    public class ovr015
    {
        ...
        public static void locked_door()
        {
            if (gbl.game_state == GameState.DungeonMap)
            {
        ...
        private static void MapSetDoorUnlocked(int mapDir, int mapY, int mapX)
        {
            if (mapX < 0 || mapX > 15 ||
                mapY < 0 || mapY > 15)
            {
        ...
        private static void MovePartyForward()
        {
            seg044.PlaySound(Sound.sound_a);
            seg049.SysDelay(50);
            ...
            {
                _stepGameTime.step_game_time(2, 1);
            }
            else
            {
                _stepGameTime.step_game_time(1, 1);
            }
        }

        private static bool AnyPlayerHasSkill(SkillType skill)
        {
            foreach (Player player in gbl.TeamList)
            {
        ...
        private static void TryStepForward()
        {
