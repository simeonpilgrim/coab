    ...
    class ovr025
    {
        ...
        internal static void load_missile_dax(bool flipIcon, byte iconOffset, Icon iconAction, int iconIdx) /* sub_67924 */
        {
            ...
            else
            {
                ...
                if (src != null)
                {
                    Array.Copy(src.data, 0, gbl.missile_dax.data, iconOffset * dataSize, dataSize);
                }
                else
                {
                    Array.Clear(gbl.missile_dax.data, iconOffset * dataSize, dataSize);
                }
            }
        }
        ...
        internal static List<CombatPlayerIndex> BuildNearTargets(int max_range, Player player) /*near_enermy*/
        {
            ...
            var nearTargets = new List<CombatPlayerIndex>();
